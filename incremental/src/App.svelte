...
{#if mounted}
	...
	<section class="px-4 -mt-16 max-w-2xl mx-auto space-y-4">
		...
		<li in:fly={{y: 40, delay: 0}} class:opacity-30={!isLoggedIn} class="rounded-2xl bg-white p-8 border border-gray-700">
		...
		<li in:fly={{y: 40, delay: 100}} class:opacity-30={!isLoggedIn} class="opacity-30 rounded-2xl bg-white p-8 border border-gray-700">
			<div class="flex items-center">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
